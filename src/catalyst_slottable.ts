/**
 * (src)[https://github.com/github/catalyst/blob/add-slottable-behavior/src/slottable.ts]
 * (docs)[https://github.com/github/catalyst/blob/cb47afdda034a8fc2d77ba6046a29098a83d9052/docs/_guide/slottable.md]
 */
import type { CustomElementClass } from '@github/catalyst/lib/custom-element.js';
import { controllable, attachShadowCallback } from '@github/catalyst/lib/controllable.js';
import { createMark } from '@github/catalyst/lib/mark.js';
import { createAbility } from '@github/catalyst/lib/ability.js';
